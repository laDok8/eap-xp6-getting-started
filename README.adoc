= Getting Started with JBoss EAP XP 6 on OpenShift
...
Then install the Helm chart for EAP XP 6 to install the application into OpenShift.
[source,shell]
----
helm install eap-xp6  --repo https://jbossas.github.io/eap-charts/ eap-xp6
----
...
[source,shell]
----
echo https://$(oc get route eap-xp6 --template='{{ .spec.host }}')
----
